        ...
        <div className="input-container">
          <div className="form-gp-helf">
            ...
            <div className="radios">
              ...
              <div className="radio-gp gender">
                <input type="radio" name="" id="felame" />
          ...
          <div className="form-gp">
            ...
            <div className="radios marital_status">
              <div className="radio-gp">
                <input type="radio" name="" id="single" />
                <label for="single">Single</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="married" />
                <label for="married">Married</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="windowed" />
                <label for="windowed">Widowed</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="divorced" />
                <label for="divorced">Divorced</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="separate" />
                <label for="separate">Separate</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="deFacto" />
        ...
        <div className="input-container">
          <div className="form-gp">
            ...
            <div className="radios dependent_number">
              <div className="radio-gp">
                <input type="radio" name="" id="one_person" />
                <label for="one_person">1 person</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="two_person" />
                <label for="two_person">2 person</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="three_person" />
                <label for="three_person">3 person</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="four_person" />
                <label for="four_person">4 person</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="five_person_plus" />
        ...
        <div className="input-container">
          <div className="form-gp">
            ...
            <div className="radios qualification">
              <div className="radio-gp">
                <input type="radio" name="" id="under_graduate" />
                <label for="under_graduate">Under Graduate</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="graduate" />
                <label for="graduate">Graduate</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="post_graduate" />
        ...
        <div className="input-container">
          <div className="form-gp">
            ...
            <div className="radios home_ownership">
              <div className="radio-gp">
                <input type="radio" name="" id="owned_property" />
                <label for="owned_property">Owned</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="company_property" />
                <label for="company_property">Company's Property</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="livingParent_property" />
                <label for="livingParent_property">
                  Living with Parents/Relatives
                </label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="mortgaged_property" />
                <label for="mortgaged_property">Mortgaged</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="rented_property" />
        ...
        <div className="input-container">
          <div className="form-gp">
            ...
            <div className="radios stay_years">
              <div className="radio-gp">
                <input type="radio" name="" id="1year_stay" />
                <label for="1year_stay">1 year</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="1_5years_stay" />
                <label for="1_5years_stay">1 year - 5 years</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="5_10years_stay" />
                <label for="5_10years_stay">5 years - 10 years</label>
              </div>
              <div className="radio-gp">
                <input type="radio" name="" id="10years_above_stay" />
